      ...
      <div className={`${rootClassName}__section`}>
        ...
        <div className={`${rootClassName}__buttons`}>
          ...
          <FilterButton
            ...
            onClick={(clicked) => filtersStore.setFilter("offices", clicked)}
          />
        </div>
      </div>
      <div className={`${rootClassName}__section`}>
        ...
        <div className={`${rootClassName}__buttons`}>
          ...
          <FilterButton
            ...
            onClick={(clicked) => filtersStore.setFilter("company", clicked)}
          />
        </div>
      </div>
      <div className={`${rootClassName}__section`}>
        ...
        <div className={`${rootClassName}__buttons`}>
          ...
          <FilterButton
            ...
            onClick={(clicked) => filtersStore.setFilter("mortgage", clicked)}
          />
          <FilterButton
          ...
          <FilterButton
            ...
            onClick={(clicked) => filtersStore.setFilter("installApp", clicked)}
          />
        </div>
      </div>
      <div className={`${rootClassName}__section`}>
        ...
        <FilterButton
          ...
          onClick={(clicked) => filtersStore.setFilter("lessWorkload", clicked)}
        />
